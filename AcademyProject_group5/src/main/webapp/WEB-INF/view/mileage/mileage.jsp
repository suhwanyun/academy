...
<jsp:include page="/WEB-INF/view/header/header.jsp" />
	 ...
	 <div class="text-center">
		...
		<img
			...
			<img
				class="img-circle img-thumbnail" 
				src="/images/mil03.png" alt="" />
			<img
				class="img-circle img-thumbnail imgMar" 
				src="/images/mil04.png" alt="" />
		
			<a id="mil3" 
			class="btn btn-link btn-lg col-xs-6"><span>허쉬초콜릿드링크</span></a>
			...
			class="btn btn-link btn-lg col-xs-6"><span>ABC초콜릿</span></a>
				...
				<img
				class="img-circle img-thumbnail" 
				src="/images/mil05.png" alt="" />
				<img
				class="img-circle img-thumbnail imgMar" 
				src="/images/mil06.png" alt="" />
